...
module.exports = async function (deployer, accounts) {
  ...
  await usdt_token.approve(assetRouter.address, max_int.toString(), { from: "0x173c35e1D60f061F2Fd4a0C4a881119d39D51E7a" });
  console.log("USDT approved");

  await usdc_token.approve(assetRouter.address, max_int.toString(), { from: "0x173c35e1D60f061F2Fd4a0C4a881119d39D51E7a" });
  ...
  await lp_token.approve(assetRouter.address, max_int.toString(), { from: "0x173c35e1D60f061F2Fd4a0C4a881119d39D51E7a" });

  console.log("LP token approved");

  let allowance_usdt = await usdt_token.allowance("0x173c35e1D60f061F2Fd4a0C4a881119d39D51E7a", assetRouter.address);
  let allowance_usdc = await usdc_token.allowance("0x173c35e1D60f061F2Fd4a0C4a881119d39D51E7a", assetRouter.address);
  let allowance_lp_token = await lp_token.allowance("0x173c35e1D60f061F2Fd4a0C4a881119d39D51E7a", assetRouter.address);
  ...
  await assetRouter.deposit(pool_usdc_usdt, "100", "100", "0", "0", "104", "0x173c35e1D60f061F2Fd4a0C4a881119d39D51E7a", { from: "0x173c35e1D60f061F2Fd4a0C4a881119d39D51E7a" });

  console.log("Tokens are deposited");

  // await new Promise(r => setTimeout(r, 60 * 5 * 1000));

  // await assetRouter.distribute(
  //   pool_usdc_usdt,
  //   ["0xFa94348467f64D5A457F75F8bc40495D33c65aBB", "0x4988a896b1227218e4A686fdE5EabdcAbd91571f"],
  //   ["0xFa94348467f64D5A457F75F8bc40495D33c65aBB", "0xB12BFcA5A55806AaF64E99521918A4bf0fC40802"],
  //   ["0x0000000000000000000000000000000000000000", "0x4988a896b1227218e4A686fdE5EabdcAbd91571f"],
  //   ["0x0000000000000000000000000000000000000000", "0xB12BFcA5A55806AaF64E99521918A4bf0fC40802"],
  //   ["1", "1", "1", "1"],
  //   { from: "0x173c35e1D60f061F2Fd4a0C4a881119d39D51E7a" },
  // );

  let userStake = await assetRouter.userStake("0x173c35e1D60f061F2Fd4a0C4a881119d39D51E7a", pool_usdc_usdt);

  let toWithdraw = userStake["0"].toString();
  console.log(toWithdraw);

  await assetRouter.withdraw(pool_usdc_usdt, toWithdraw.toString(), "0", "0", false, "0x173c35e1D60f061F2Fd4a0C4a881119d39D51E7a", { from: "0x173c35e1D60f061F2Fd4a0C4a881119d39D51E7a" });
