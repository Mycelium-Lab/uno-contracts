...
module.exports = async (deployer, network) => {
    ...
    {
        // AssetRouter upgrade
        const UnoAssetRouter = await readAddress('pancakeswap-router')
        ...
        const proposal = await client.createProposal({
            contractId: `bsc-${UnoAssetRouter}`, // Target contract
    ...
    {
        // Farm upgrade
        const UnoFarmFactory = await readAddress('pancakeswap-factory')
        ...
        const proposal = await client.createProposal({
            contractId: `bsc-${UnoFarmFactory}`, // Target contract
            title: 'Upgrade', // Title of the proposal
            description: 'Upgrade', // Description of the proposal
            type: 'custom', // Use 'custom' for custom admin actions
