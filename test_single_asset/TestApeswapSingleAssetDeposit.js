        ...
        describe('deposit token', () => {
            ...
            before(async () => {
                ...
                if (farmAddress === constants.ZERO_ADDRESS) {
                    ...
                    stakingRewardsBalanceBefore = (await masterApe.userInfo(pid, farm.address)).amount
                }
                ({
            ...
            it('stakes tokens in StakingRewards contract', async () => {
                ...
                const stakingRewardsBalance = new BN((await masterApe.userInfo(pid, farm.address)).amount)
