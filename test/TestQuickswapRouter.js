...
const DQuickHolder = '0xcf0b86f9944a60a0ba22b51a33c11d9e4de1ce9f'//has to be unlocked
const stakingRewardsOwner = '0x476307dac3fd170166e007fcaa14f0a129721463'//has to be unlocked
const account1 = "0xA4d07c23F28A1eb1ae471e530c3f5e0038d282F2"//has to be unlocked
const account2 = "0x4AF7f964fb155cc2d59fcD8cA6f2E956d995cBDE"//has to be unlocked
...
contract('UnoAssetRouterQuickswap', accounts => {
    ...
    before(async () => {
        ...
        const rewardsToken = await IUniswapV2Pair.at(rewardsTokenAddress)
        ...
        await stakingRewardsFactory.update(stakingToken.address, rewardAmount, 100000, {from: stakingRewardsOwner})
