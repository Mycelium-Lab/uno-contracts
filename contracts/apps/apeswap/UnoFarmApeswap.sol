...
contract UnoFarmApeswap is Initializable, ReentrancyGuardUpgradeable, IUnoFarmApeswap {
    ...
    function distribute(
        ...
        IUniswapV2Router01 _apeswapRouter = apeswapRouter;
        ...
        if (rewardTokenHalf > 0) {
            if (_tokenA != _rewardToken) {
                ...
                _apeswapRouter.swapExactTokensForTokens(rewardTokenHalf, swapInfos[0].amountOutMin, route, address(this), block.timestamp);
            }
            ...
            if (_tokenB != _rewardToken) {
                ...
                _apeswapRouter.swapExactTokensForTokens(rewardTokenHalf, swapInfos[1].amountOutMin, route, address(this), block.timestamp);
            }
        }
        ...
        if (rewarderTokenHalf > 0) {
            if (_tokenA != _rewarderToken) {
                ...
                _apeswapRouter.swapExactTokensForTokens(rewarderTokenHalf, swapInfos[2].amountOutMin, route, address(this), block.timestamp);
            }

            if (_tokenB != rewarderToken) {
                ...
                _apeswapRouter.swapExactTokensForTokens(rewarderTokenHalf, swapInfos[3].amountOutMin, route, address(this), block.timestamp);
            }
        }
        }
