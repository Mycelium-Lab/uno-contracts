...
contract UnoFarmApeswap is Initializable, ReentrancyGuardUpgradeable, IUnoFarmApeswap {
    ...
    function distribute(
        ...
        IMasterApe _MasterApe = MasterApe;
        _MasterApe.withdraw(pid, 0);
        ...
        (,,reward) = _apeswapRouter.addLiquidity(_tokenA, _tokenB, IERC20(_tokenA).balanceOf(address(this)), IERC20(_tokenB).balanceOf(address(this)), swapInfos[0].amountOutMin, swapInfos[1].amountOutMin, address(this), block.timestamp);
