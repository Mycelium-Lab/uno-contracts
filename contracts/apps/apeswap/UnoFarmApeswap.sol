...
contract UnoFarmApeswap is Initializable, ReentrancyGuardUpgradeable {
    ...
    function deposit(uint256 amountA, uint256 amountB, uint256 amountAMin, uint256 amountBMin, uint256 amountLP, address origin, address recipient) external nonReentrant onlyAssetRouter returns(uint256 sentA, uint256 sentB, uint256 liquidity){
        ...
        MasterApe.deposit(pid, liquidity);
    ...
    function distribute(
        ...
        collectFees(feeSwapInfo, feeInfo, IBEP20(rewardToken));
     ...
     */
    function collectFees(SwapInfo calldata feeSwapInfo, FeeInfo calldata feeInfo, IBEP20 token) internal {
