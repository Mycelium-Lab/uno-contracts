...
import './interfaces/IUnoAssetRouterPancakeswap.sol'; 
...
contract UnoAssetRouterPancakeswap is Initializable, PausableUpgradeable, UUPSUpgradeable, IUnoAssetRouterPancakeswap {
    ...
    function distribute(
        ...
        reward = farm.distribute(swapInfos, feeSwapInfo, IUnoFarm.FeeInfo(feeTo, fee));
    ...
    function _addLiquidity(
        ...
        IERC20(tokenA).approve(address(PancakeswapRouter), amountA);
        IERC20(tokenB).approve(address(PancakeswapRouter), amountB);
    ...
    function _addLiquidityETH(
        ...
        IERC20(token).approve(address(PancakeswapRouter), amount);
    ...
    function _removeLiquidity(
        ...
        IERC20(lpPair).approve(address(PancakeswapRouter), amount);
