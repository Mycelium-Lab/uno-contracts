...
contract UnoFarmQuickswap is Initializable, ReentrancyGuardUpgradeable, IUnoFarmQuickswap {
    ...
    function distribute(
        ...
        if (_tokenA != _rewardToken) {
            ...
            _quickswapRouter.swapExactTokensForTokens(rewardTokenHalf, swapInfos[0].amountOutMin, route, address(this), block.timestamp);
        }
        if (_tokenB != _rewardToken) {
            ...
            _quickswapRouter.swapExactTokensForTokens(rewardTokenHalf, swapInfos[1].amountOutMin, route, address(this), block.timestamp);
        }
