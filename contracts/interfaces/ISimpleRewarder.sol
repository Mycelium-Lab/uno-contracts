...
interface ISimpleRewarder {
    ...
    function poolInfo(uint256 pid) external view returns (ISimpleRewarder.PoolInfo memory);

    /// @notice Info of each user that stakes LP tokens.
    function userInfo(uint256 arg1, address arg2) external view returns (ISimpleRewarder.UserInfo memory);
